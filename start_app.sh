#!/bin/bash
set -u
BACKEND_DIR="/storage/users/job37yv/Projects/CarboDB_v3/"
FRONTEND_DIR="/storage/users/projects/CarboDB-App-v2/frontend"
...
cd /storage/users/projects/CarboDB-App-v2/
  nohup uvicorn webapp.app.main:app --host 0.0.0.0 --port 8091 \
  > logs/webapp.log 2>&1 &
...
echo ""
echo "Backend: http://132.187.22.206:8091"
echo "Frontend: http://132.187.22.206:5174/analysis"
